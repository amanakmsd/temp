                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown dropdown-user">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo base_url('logout') ?>"><i class="pe-7s-power"></i> Logout</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
