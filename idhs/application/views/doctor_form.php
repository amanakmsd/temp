                    ...
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('doctor/create','class="form-inner"') ?> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <img src="<?php echo base_url(html_escape($doctor->picture)) ?>" alt="Picture" class="img-thumbnail hospital-form-logo" />
                                </div>
                            </div>
                            <?php } ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="mobile" class="form-control" type="number" placeholder="Phone Number" id="mobile" value="<?php echo html_escape($doctor->mobile); ?>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="email" class="form-control" type="email" placeholder="Email ID" id="email"  value="<?php echo html_escape($doctor->email); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="consultancy_fees" class="col-xs-3 col-form-label">Consultancy fees <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="consultancy_fees" type="text" class="form-control" id="consultancy_fees" placeholder="Consultancy fees" value="<?php echo html_escape($doctor->consultancy_fees); ?>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="experience" class="col-xs-3 col-form-label">Experience</label>
                                <div class="col-xs-9">
                                    <input name="experience" type="text" class="form-control" id="experience" placeholder="Experience" value="<?php echo html_escape($doctor->experience); ?>" >
                                </div>
                            </div>
