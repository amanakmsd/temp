...
class Booking extends CI_Controller {
	...
	public function index()
	{
		...
		$data['bookings'] = $this->booking_model->read($booking_type, $this->my_encrypt->decode($query_department_id), $this->my_encrypt->decode($query_hospital_id));
	...
	{
		$booking_id = $this->my_encrypt->decode($booking_id);
