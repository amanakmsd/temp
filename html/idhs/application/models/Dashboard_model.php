...
class Dashboard_model extends CI_Model {
	...
	{
		$user_array = array('email' => strtolower($data['email']), 'password' => $data['password'], 'user_role' => $data['user_role'], 'create_date' => $data['create_date'], 'update_date' => $data['update_date'], 'status' => $data['status']);
		$this->db->insert('user',$user_array);
		$user_id = $this->db->insert_id();

		$toRemove = ['email', 'password', 'user_role', 'status']; 
