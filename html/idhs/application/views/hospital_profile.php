            ...
            <div class="panel-heading no-print">
                <div class="row">
                    ...
                    <div class="col-md-3" align="right" style="padding: 21px;">
                        <div class="btn-group"> 
                            <a class="btn btn-success" href="<?php echo base_url("hospital/edit/".$this->my_encrypt->encode($hospital->hospital_id)) ?>">Edit</a>  
                    ...
                    <div class="col-sm-12">  
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="border-right">Services Type</td>
                                    <td>
                                        <?php echo (!empty($hospital->services_type)?html_escape($hospital->services_type):'NA') ?>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <?php
                                            if(!empty($hospital->organs_operated)) {
                                                ...
                                                foreach ($organs_operated as $organ_key => $organs_value) {
                                                    echo '<li>'.$organ_list[$organs_value].'</li>';
                                        ...
                                        <?php
                                            if(!empty($hospital->speciality_operations)) {
                                                ...
                                                foreach ($speciality_operations as $speciality_key => $speciality_value) {
                                                    echo '<li>'.$speciality_list[$speciality_value].'</li>';
                                        ...
                                        <table class="table table-sm">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo (!empty($hospital->parking_area)?html_escape($hospital->parking_area) : 'NA') ?></td>
                                                </tr>
                                                <tr>
