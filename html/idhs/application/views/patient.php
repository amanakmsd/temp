                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td>
                                        <div class="action-btn">
                                            <a href="<?php echo base_url("patient/profile/".$this->my_encrypt->encode($patient->user_id)) ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
                                            <a href="<?php echo base_url("patient/delete/".$this->my_encrypt->encode($patient->user_id)) ?>" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure! You want to delete?')"><i class="fa fa-trash"></i></a>
                                        </div> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
