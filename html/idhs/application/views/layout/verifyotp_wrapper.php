...
<html lang="en">
    <head>
        ...
        <title>Verify OTP - IDHS Hospital Management</title>
            ...
            <div class="container-center">
                <div class="panel panel-bd">
                    ...
                    <div class="panel-body">
                        <?php echo form_open('','id="loginForm" novalidate'); ?>
                            <div class="form-group">
                                <label class="control-label" for="signup_otp">OTP</label>
                                <input type="text" placeholder="Please enter otp" name="signup_otp" id="signup_otp" class="form-control"> 
                            </div>
                ...
                <div class="form-group" align="center">
                    <strong>Do not have an account? <a href="/hospital/signup">Sign Up</a></strong>
                </div>
                <?php } ?>
            </div>
        </div>
