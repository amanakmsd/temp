                ...
                <div class="row">
                    <div class="col-md-8">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="<?php if($query_disease_id == 'top_disease') { echo 'active'; } ?>"><a href="?disease_type=top_disease">Top Disease</a></li>
                            <li class="<?php if($query_disease_id == 'seasonal_disease') { echo 'active'; } ?>"><a href="?disease_type=seasonal_disease">Seasonal Disease</a></li>
                            <li class="<?php if($query_disease_id == 'regional_disease') { echo 'active'; } ?>"><a href="?disease_type=regional_disease">Regional Disease</a></li>
                        </ul>
                    </div>
                            ...
                            <?php foreach ($diseases as $disease) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url("disease/edit/$disease->disease_id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a> 
                                        <a href="<?php echo base_url("disease/delete/$disease->disease_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure! You want to delete? ')"><i class="fa fa-trash"></i></a>
                                        </div> 
                                    </td>
                                    <?php } ?>
                                </tr>
