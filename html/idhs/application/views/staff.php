                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td>
                                        <div class="action-btn">
                                            <a href="<?php echo base_url("staff/edit/$staff->user_id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>
                                        
                                            <a href="<?php echo base_url("staff/delete/$staff->user_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure! You want to delete?')"><i class="fa fa-trash"></i></a>
                                        </div> 
                                    </td>
