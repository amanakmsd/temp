                        ...
                        <?php if (!empty($schedules)) { ?>
                            ...
                            <?php foreach ($schedules as $schedule) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url("doctor/profile/$schedule->doctor_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
                                        <a href="<?php echo base_url("schedule/edit/$schedule->schedule_id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a> 
                                        <a href="<?php echo base_url("schedule/delete/$schedule->schedule_id") ?>" onclick="return confirm('Are you sure,  You want to delete ?')" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
