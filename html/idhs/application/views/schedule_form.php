                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                        ...
                        <?php echo form_open('schedule/create','class="form-inner" id="schedule_form"') ?>
                            ...
                            <div class="form-group">
                                <label for="doctor_id">Doctor <i class="text-danger">*</i></label>
                            ...
                            <div class="form-group">
                                <label>Select Date Range <i class="text-danger">*</i> </label>
                                <div class="row">
                            ...
                            <div class="form-group">
                                <label for="off_duty_days">Off duty days</label>
                            ...
                            <div class="form-group">
                                <label for="date">Leave Days</label>
                            ...
                            <div class="form-group">
                                <label>Select Slots <i class="text-danger">*</i> </label>
                                <div class="row">
                                    <div class="col-xs-10" id="more_slots_container">
                                        <?php
                            ...
                            <div class="form-group">
                                <label for="petient_per_day">Total patient per day</label>
