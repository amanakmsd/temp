                                ...
                                <select onchange="filterBookingForm('bookingFilterForm');" name="department" class="form-control">
                                    ...
                                    <?php
                                        foreach ($department_list as $key => $value) {
                                            if($key == $query_department_id) {
                                                $selectedValue = "selected='selected'";
                                            } else {
                                                $selectedValue = '';
                                            }

                                            echo "<option value='".$key."' ".$selectedValue.">".$value."</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                                ...
                                <select onchange="filterBookingForm('hospitalFilterForm');" name="hospital_id" class="form-control">
                                    ...
                                    <?php
                                        foreach ($hospital_list as $hospital_row) {
                                            if($hospital_row->hospital_id == $query_hospital_id) {
                                                $selectedValue1 = "selected='selected'";
                                            } else {
                                                $selectedValue1 = '';
                                            }

                                            echo "<option value='".$hospital_row->hospital_id."' ".$selectedValue1.">".$hospital_row->name."</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td>
                                        <div class="ui buttons">
                                            ...
                                            <a class="ui button" href="<?php echo base_url("booking/reject/$booking->booking_id") ?>" onclick="return confirm('Are you sure! You want to reject? ')">Reject</a>
                                            <div class="or"></div>
                                            <?php } ?>
                                            <a class="ui positive button" href="<?php echo base_url("booking/rescdule/$booking->booking_id") ?>" onclick="return confirm('Are you sure! You want to reschedule? ')">Reschedule</a>
                                        </div>
                                    </td>
                                    <?php } ?>
                                </tr>
