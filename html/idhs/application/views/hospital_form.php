    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <?php echo form_open_multipart('hospital/create','class="form-inner" id="hospital_data_form"') ?> 
                    <div class="col-md-3">
                    ...
                    <div class="col-md-8 col-sm-12">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="mobile">PM-JAY <i class="text-danger">*</i></label>
                            ...
                            <div class="form-group">
                                <label>Hospital Timing <i class="text-danger">*</i></label>
                                <div class="form-group row">
                            ...
                            <div class="form-group">
                                ...
                                <input name="mobile" class="form-control" type="number" placeholder="Phone Number" id="mobile" value="<?php echo html_escape($hospital->mobile); ?>" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" >
                            </div>

                            <div class="form-group">
                                <label for="no_of_ambulance">No. of Ambulance <i class="text-danger">*</i></label>
                                <input name="no_of_ambulance" class="form-control" type="number" placeholder="No. of Ambulance" id="no_of_ambulance" value="<?php echo html_escape($hospital->no_of_ambulance); ?>" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" >
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-offset-3 col-sm-6">
                                    <div class="ui buttons">
                                        ...
                                        <div class="or"></div>
                                        <button id="hospital_submit_button" class="ui positive button">Save</button>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#hospital_submit_button").click(function (e) {
            e.preventDefault();

            var strStartTime = $('#hospital_data_form').find('input[name="start_time"]').val();
            var strEndTime = $('#hospital_data_form').find('input[name="end_time"]').val();
            ...
            $( "#hospital_data_form" ).trigger( "submit" );
